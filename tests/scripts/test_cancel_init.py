...
import src.scripts.test_cancel_init as test_cancel_init


class TestCancelInit:
    
    @patch('src.scripts.test_cancel_init.cancel_utils.get_sse_url')
    @patch('src.scripts.test_cancel_init.requests.get')
    @patch('src.scripts.test_cancel_init.requests.Session')
    def test_cancel_initialization_success(self, mock_session_class, mock_get, mock_get_sse_url):
        """Test successful cancel initialization"""
        ...
        test_cancel_init.test_cancel_initialization()
    ...
    @patch('src.scripts.test_cancel_init.requests.get')
    @patch('src.scripts.test_cancel_init.requests.Session')
    def test_cancel_initialization_with_custom_url_and_timeout(self, mock_session_class, mock_get, mock_get_sse_url):
        """Test cancel initialization with custom URL and timeout"""
    ...
    @patch('src.scripts.test_cancel_init.requests.get')
    @patch('src.scripts.test_cancel_init.requests.Session')
    def test_cancel_initialization_base_url_exception(self, mock_session_class, mock_get, mock_get_sse_url):
    ...
    @patch('src.scripts.test_cancel_init.requests.get')
    @patch('src.scripts.test_cancel_init.requests.Session')
    def test_cancel_initialization_post_http_error(self, mock_session_class, mock_get, mock_get_sse_url):
    ...
    @patch('src.scripts.test_cancel_init.requests.get')
    @patch('src.scripts.test_cancel_init.requests.Session')
    def test_cancel_initialization_post_timeout(self, mock_session_class, mock_get, mock_get_sse_url):
    ...
    @patch('src.scripts.test_cancel_init.requests.get')
    @patch('src.scripts.test_cancel_init.requests.Session')
    def test_cancel_initialization_post_connection_error(self, mock_session_class, mock_get, mock_get_sse_url):
    ...
    @patch('src.scripts.test_cancel_init.requests.get')
    @patch('src.scripts.test_cancel_init.requests.Session')
    def test_cancel_initialization_post_generic_exception(self, mock_session_class, mock_get, mock_get_sse_url):
